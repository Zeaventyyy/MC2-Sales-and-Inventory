...
{
    public partial class AdminFormRazer : Form
    {
        SqlDataAdapter da = new SqlDataAdapter();
        DataTable dt = new DataTable();
        int i = 0;

        public AdminFormRazer()
        {
            InitializeComponent();
        }
        ...
        private void AdminFormRazer_Load(object sender, EventArgs e)
        {
            timer1.Start();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                quantity = int.Parse(txtQuantity1.Text);
            }
            catch { }
