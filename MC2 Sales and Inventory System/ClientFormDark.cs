...
{
    public partial class ClientFormDark : Form
    {
        ...
        public ClientFormDark(string sessionId)
        {
            InitializeComponent();
        ...
        private void ClientFormDark_Load(object sender, EventArgs e)
        {
        ...
        private void btnPay_Click(object sender, EventArgs e)
        {
            ...
            InputCashDialogDark enterCash = new InputCashDialogDark(totalPrice);
