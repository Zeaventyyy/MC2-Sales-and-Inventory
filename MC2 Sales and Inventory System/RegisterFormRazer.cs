...
{
    public partial class RegisterFormRazer : Form
    {
        string dt2 = DateTime.Now.ToLongTimeString();
        string dt3 = DateTime.Now.ToLongDateString();

        public RegisterFormRazer()
        {
            InitializeComponent();
        }

        private void RegisterFormRazer_Load(object sender, EventArgs e)
        {
            tmDateTime.Start();
            dt2 = DateTime.Now.ToLongTimeString();
            dt3 = DateTime.Now.ToLongDateString();
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            else if (chbAgree.Checked)
            {
                ...
                {
                    SqlDataAdapter SDA = new SqlDataAdapter("INSERT INTO LoginTable (Username,Password,Question,Answer,Date_Registered,Time_Registered)VALUES ('" + txtUsername.Text + "','" + txtConfirmPassword.Text + "','" + cboQuestion.Text + "','" + txtAnswer.Text + "','" + Convert.ToDateTime(dt3) + "','" + Convert.ToDateTime(dt2) + "')", Program.Connection);
