...
{
    public partial class AdminFormDark : Form
    {
        SqlDataAdapter da = new SqlDataAdapter();
        DataTable dt = new DataTable();
        int i = 0;

        public AdminFormDark()
        {
            InitializeComponent();
        }
        ...
        private void AdminFormDark_Load(object sender, EventArgs e)
        {
            timer1.Start();
