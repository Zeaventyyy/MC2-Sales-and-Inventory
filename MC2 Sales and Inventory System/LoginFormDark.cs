...
{
    public partial class LoginFormDark : Form
    {
        ...
        {
            public static string CurrentLoggedInUser1
            {
                get;
                set;
            }
        ...
        string dt4 = DateTime.Now.ToString("HH:mm:ss");

        private void LoginFormDark_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                dt4 = DateTime.Today.ToLongTimeString();
        ...
        private int attempts1 = 5;
        private int count1 = 30;

        private void btnLogin_Click(object sender, EventArgs e)
        {
            UserInformation.CurrentLoggedInUser1 = txtUsername.Text.Trim();
            ...
            else
            {
                ...
                if (dt.Rows[0][0].ToString() == "1")
                {
                    ...
                    else
                    {
                        ...
                        SqlDataAdapter SDA = new SqlDataAdapter("INSERT INTO HistoryLogin (Username,Date,Time_LoggedIn,SessionId)VALUES ('" + txtUsername.Text + "','" + dt2 + "','" + dt4 + "', '" + sessionId + "')", Program.Connection);
                        ...
                        if (chkRememberMe.Checked)
                        {
                            ...
                            Properties.Settings.Default.Password = txtPassword.Text;
                            MessageBox.Show("Welcome, " + txtUsername.Text + " !", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            (new ClientFormDark(sessionId)).ShowDialog();
                            txtUsername.ForeColor = Color.LightGray;
                            txtPassword.ForeColor = Color.LightGray;
                            txtUsername.BackColor = Color.FromArgb(255, 255, 192);
                            txtPassword.BackColor = Color.FromArgb(255, 255, 192);
                ...
                {
                    attempts1--;
                    MessageBox.Show("Your Username or Password is Incorrect." + Environment.NewLine + "You have " + attempts1 + " attempt(s) left!", "Notice !", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    ...
                    if (attempts1 == 0)
                    {
                        ...
                        label5.Text = "00:" + count1.ToString();
                        timer1.Start();
                        timer1.Enabled = true;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                label5.Text = "00:0" + count1.ToString();
            }
            else
            {
