...
{
    public partial class HistoryClientListFormRazer : Form
    {
        

        public HistoryClientListFormRazer()
        {
            InitializeComponent();
        }

        private void HistoryClientListFormRazer_Load(object sender, EventArgs e)
        {
